...
import units
from fe import analyze_feature_importance
...
if __name__ == '__main__':
    ...
    parser.add_argument('--label_path', type=str, default=r"/home/zy/experiment/fsq/0.01aug_fourlabel_cate_2.pkl")
    parser.add_argument('--graphs_path', type=str, default=r"/home/zy/experiment/fsq/0.01aug_four_net_cate_2.pkl")
    parser.add_argument('--n_feat_path', type=str, default=r"/home/zy/experiment/fsq/0.01aug_four_nfeat_cate_2.pkl")
    parser.add_argument('--e_feat_path', type=str, default=r"/home/zy/experiment/fsq/0.01aug_four_efeat_cate_2.pkl")
    ...
    importance_scores = analyze_feature_importance(
        model_GATRE, model_M, testGs, test_n_feat, test_e_feat, test_labels, k=args.period
    )